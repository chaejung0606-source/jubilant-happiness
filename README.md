...
| 파일 | 설명 |
|---|---|
| `회의록도구.exe` | **완성된 프로그램.** `앱 만들기.bat` 을 실행하면 만들어집니다. |
| `앱 만들기.bat` | `.exe` 를 만드는 실행기. 처음 한 번만 씁니다. |
| `앱만들기.py` | 실제 빌드 작업을 하는 스크립트 |
| `회의록도구.pyw` | 프로그램 본체 (원본 소스) |
...
고친 뒤에는 `앱 만들기.bat` 을 다시 실행해 `.exe` 를 새로 만들어야 반영됩니다.
